...
| E3 | 🟠 HIGH | 5 SM2-era cards got SM2 interval (1d) instead of FSRS (3d) | ❌ Unresolved — JSON analysis 2026-06-03 confirmed 6 cards: `1-8118`,`2-13381`,`3-7988`,`4-8508`,`5-8377`,`9-8081`. All have `stability:null`, `interval_days:1`. Root cause: rated pre-FSRS via SM2 path, `rateCard()` never set stability. Fix: in-app `rateCard(id,'good')` re-run OR direct `phase3State.progress` patch to reset `stability=3.122`, `interval_days=3`, `next_due_at=3d`, `ease_factor=2.5`. |
| E4 | 🟠 HIGH | 6 cards have mutated `ease_factor` (2.1–2.35) from pre-FSRS SM2 logic | ❌ Unresolved — Same 6 cards as E3 (overlap). Cards `1-8118` (2.15), `2-13381` (2.20), `5-8377` (2.35), `9-8081` (2.35) have sub-default ease. Reset ease_factor=2.5 as part of E3/E4 combined patch. |
| E3b | 🟠 HIGH | 6 ghost-seen cards: `11-13303`,`2-8719`,`7-8271`,`1-7713`,`2-8755`,`4-13423` — stage='review', seen_count=1, last_rating=null, stability=null, interval=0. Pre-E2 casualties where record() ran but rateCard() never did. | ❌ Unresolved (data patch) — reset to stage='new', seen_count=0 so FSRS treats them as fresh. |
