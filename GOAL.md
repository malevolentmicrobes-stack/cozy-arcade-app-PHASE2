...
- 2026-06-07 Codex browser premortem addendum added to `SENIOR_DEV_AUDIT_2026_06_07.md`: PHASE2 CDP validation reconfirmed FSRS 17/17, smoke 6/6, SW v7, no Beta Spaced text, Shadow Dungeon due-scope sync, and no buried-like leak for the supplied JSON examples; remaining production risks are HUD `×` not exporting a file, undo not restoring full transaction/session state, and possible home select option churn rather than a visible drawer flash.
